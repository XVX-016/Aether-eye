...
const NAV_ITEMS: { key: MainSection; label: string; short: string }[] = [
  { key: "aircraft-detection", label: "Aircraft Detection", short: "Detection" },
  { key: "change-detection", label: "Change Detection", short: "Change" },
  { key: "aircraft-classification", label: "Aircraft Classification", short: "Classify" },
  { key: "metrics-dashboard", label: "Metrics Dashboard", short: "Metrics" },
];
